...
规则: 超短线(3-10分钟持仓)。小保证金高杠杆，首个止盈要快；止损给足ATR呼吸空间，避免刚开仓被噪音扫掉。long_entry_low < long_entry_high必须成立。只输出JSON，不要其他文字。`
...
- 杠杆65-95x（小保证金承载高杠杆，ATR越大杠杆越低）
- 仓位0.15-0.60%%（position_size_pct用小数 0.004=0.4%%）
